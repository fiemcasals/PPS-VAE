...
- `src/components/World/Environment.jsx`: _(Empty)_ Intended to encapsulate Sky, Lights, and environmental effects.
- `src/components/World/Grid.jsx`: _(Empty)_ Intended to encapsulate the visual grid helper.
...
2.  **Check Constraints**: Will this exceed 200 lines? If yes, plan the split _before_ writing code.
